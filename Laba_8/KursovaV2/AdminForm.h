...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->AddEduInfo->Text = L"Переглянути середній бал";
			...
			this->AddTime->Text = L"Пройдені тести";
			this->AddTime->UseVisualStyleBackColor = true;
			this->AddTime->Click += gcnew System::EventHandler(this, &AdminForm::AddTime_Click);
			// 
			// button1
			// 
			...
			this->textBox1->Size = System::Drawing::Size(334, 19);
			...
			this->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 7.875F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
...
private: System::Void AddTime_Click(System::Object^ sender, System::EventArgs^ e) {
}
};
}

...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Додаток для тестування";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Проєкт створив, студент групи КІ2-22-2, Мукомела Андрiй";
			// 
			// button1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		Laba_8::MyForm^ form2 = gcnew Laba_8::MyForm();
		this->Hide();
		form2->Show();
	}
};
